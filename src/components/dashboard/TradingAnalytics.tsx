      ...
      <div className="grid gap-4 md:grid-cols-[1fr_auto]">
        ...
        <div className="flex flex-col gap-4 min-w-[180px]">
          <div className="rounded-xl border border-border bg-card p-4 flex flex-col items-center">
            ...
            <DrawdownMeter current={peakDD} max={maxDrawdownPercent} />
            <div className={`mt-2 font-display text-[11px] font-bold ${peakDD / maxDrawdownPercent > 0.75 ? "text-red-500" : peakDD / maxDrawdownPercent > 0.5 ? "text-amber-500" : "text-green-500"}`}>
              {peakDD / maxDrawdownPercent > 0.75 ? "⚠ HIGH RISK" : peakDD / maxDrawdownPercent > 0.5 ? "CAUTION" : "HEALTHY"}
            </div>
          </div>
