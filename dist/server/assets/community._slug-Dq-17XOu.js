...
import { d as Route, u as useAuth, a as useNavigate, s as supabase, t as toast, L as Link } from "./router-DudJYIfW.js";
import { a as composeRefs, u as useComposedRefs, B as Button } from "./button-CVkRzbLJ.js";
import { I as Input } from "./input-Cg1AgxSs.js";
import { P as Presence, D as Dialog, a as DialogContent } from "./dialog-CVXx6z81.js";
import { c as cn } from "./utils-vYOMvTwc.js";
import { u as useControllableState, a as useId, P as Primitive, c as composeEventHandlers, d as Portal$1, b as createContextScope, h as hideOthers, R as ReactRemoveScroll, e as useFocusGuards, F as FocusScope, D as DismissableLayer } from "./index-BXyXc4LB.js";
...
function MessageBubble({ message, isMine, showAuthor, onReply, onReact, onOpenImage }) {
  const x = useMotionValue(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("group relative flex w-full px-3", isMine ? "justify-end" : "justify-start"), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reply, { className: "h-5 w-5" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          showAuthor && !isMine && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 text-[11px] text-muted-foreground", children: message.author_name || "Trader" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("relative flex items-end gap-1", isMine && "flex-row-reverse"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: cn(
                ...
                children: [
                  message.reply_to && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: cn(
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold opacity-80", children: message.reply_to.author_name || "Reply" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "line-clamp-2 opacity-80", children: message.reply_to.body || (message.reply_to.image_url ? "📷 Photo" : "") })
                      ]
                    }
                  ),
                  message.image_url && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                  ...
                  message.body && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "whitespace-pre-wrap break-words", children: message.body })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 opacity-0 transition-opacity group-hover:opacity-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open: pickerOpen, onOpenChange: setPickerOpen, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "grid h-7 w-7 place-items-center rounded-full bg-muted text-muted-foreground hover:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Smile, { className: "h-3.5 w-3.5" }) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverContent, { className: "w-auto p-1", align: isMine ? "end" : "start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: QUICK_REACTIONS.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => {
                      onReact(message, e);
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  "aria-label": "Reply",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reply, { className: "h-3.5 w-3.5" })
                }
              )
            ] })
          ] }),
          message.reactions && message.reactions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("flex flex-wrap gap-1", isMine ? "justify-end" : "justify-start"), children: message.reactions.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              onClick: () => onReact(message, r.emoji),
              className: cn(
                "flex items-center gap-1 rounded-full border px-2 py-0.5 text-xs transition-colors",
                r.mine ? "border-primary/50 bg-primary/10 text-primary" : "border-border bg-background text-muted-foreground hover:bg-muted"
              ),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: r.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: r.count })
              ]
            },
            r.emoji
          )) }),
          isMine && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 text-[10px] text-muted-foreground", children: message.read_by_others ? "Seen" : "Sent" })
        ]
      }
    )
  ] });
...
function GroupChatPage() {
  ...
  const [emojiOpen, setEmojiOpen] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      const {
        data: g
      } = await supabase.from("community_groups").select("id, name").eq("slug", slug).maybeSingle();
      if (!g) {
      ...
      const {
        data: m
      } = await supabase.from("group_members").select("user_id").eq("group_id", g.id).eq("user_id", user.id).maybeSingle();
      setIsMember(!!m);
    })();
  }, [slug, user?.id]);
  const refreshAuthors = async (userIds) => {
    const missing = userIds.filter((id2) => !authors[id2]);
    if (missing.length === 0) return;
    const {
      data
    } = await supabase.from("profiles").select("id, full_name").in("id", missing);
    if (data) {
      setAuthors((prev) => {
        const next = {
          ...prev
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      const {
        data: msgs
      } = await supabase.from("messages").select("*").eq("group_id", groupId).order("created_at", {
        ascending: true
      }).limit(200);
      const ms = msgs ?? [];
      setMessages(ms);
      ...
      if (ids.length > 0) {
        const [{
          ...
          data: rds
        }] = await Promise.all([supabase.from("message_reactions").select("*").in("message_id", ids), supabase.from("message_reads").select("message_id, user_id").in("message_id", ids)]);
        setReactions(rxs ?? []);
        const map = {};
        for (const r of rds ?? []) {
          if (!map[r.message_id]) map[r.message_id] = /* @__PURE__ */ new Set();
  ...
  reactExports.useEffect(() => {
    ...
    const channel = supabase.channel(`group:${groupId}`).on("postgres_changes", {
      ...
      setReads((prev) => {
        ...
        if (!next[r.message_id]) next[r.message_id] = /* @__PURE__ */ new Set();
  ...
  reactExports.useEffect(() => {
    ...
    const unread = messages.filter((m) => m.user_id !== user.id && !reads[m.id]?.has(user.id));
    if (unread.length === 0) return;
    (async () => {
      try {
        await supabase.from("message_reads").insert(unread.map((m) => ({
          message_id: m.id,
          user_id: user.id
        })));
      } catch {
  ...
  const notifyTyping = () => {
    ...
    typingTimeoutRef.current = window.setTimeout(() => {
      (async () => {
        try {
          await supabase.from("typing_status").delete().eq("group_id", groupId).eq("user_id", user.id);
        } catch {
        }
      })();
    }, 3e3);
  ...
  const sendMessage = async () => {
    ...
    if (imagePreview && fileInputRef.current?.files?.[0]) {
      ...
      const {
        data: signed
      } = await supabase.storage.from("chat-attachments").createSignedUrl(path, 60 * 60 * 24 * 7);
  ...
  const typingNames = typingUsers.filter((t) => t.user_id !== user?.id).map((t) => authors[t.user_id]?.split(" ")[0] || "Someone");
  if (groupId && !isMember && hasPurchase === true) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-md p-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold", children: groupName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Join this group to start chatting." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "mt-4 font-display", onClick: async () => {
        const {
          error
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/community", className: "text-xs text-muted-foreground underline", children: "Back to community" }) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-x-0 top-0 bottom-0 z-40 flex flex-col bg-background md:static md:h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex shrink-0 items-center gap-2 border-b border-border bg-background/95 px-3 py-2 pt-[calc(env(safe-area-inset-top)+0.5rem)] backdrop-blur-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => navigate({
        to: "/community"
      }), className: "grid h-9 w-9 place-items-center rounded-full hover:bg-muted", "aria-label": "Back", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-9 w-9 place-items-center rounded-full bg-primary text-sm font-bold text-primary-foreground", children: groupName.charAt(0).toUpperCase() || "G" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate font-display text-sm font-semibold", children: groupName || "Group" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate text-[11px] text-muted-foreground", children: typingNames.length > 0 ? `${typingNames.slice(0, 2).join(", ")} typing…` : "Active community" })
      ] })
    ] }),
    hasPurchase === false && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center gap-2 border-b border-border bg-warning/10 px-3 py-2 text-[11px] text-warning", children: [
      "🔒 Read-only — ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/buy", className: "underline", children: "purchase a challenge" }),
      " to post."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollRef, className: "flex-1 space-y-2 overflow-y-auto py-3", children: enriched.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-full place-items-center text-sm text-muted-foreground", children: "Be the first to say hello 👋" }) : enriched.map((m, i) => {
      const prev = i > 0 ? enriched[i - 1] : null;
      const showAuthor = !prev || prev.user_id !== m.user_id;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(MessageBubble, { message: m, isMine: m.user_id === user?.id, showAuthor, onReply: setReplyTo, onReact, onOpenImage: setLightbox }, m.id);
    }) }),
    canPost && replyTo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-t border-border bg-muted/40 px-3 py-2 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold text-primary", children: [
          "Replying to ",
          replyTo.author_name
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate text-muted-foreground", children: replyTo.body || (replyTo.image_url ? "📷 Photo" : "") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setReplyTo(null), className: "rounded-full p-1 hover:bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3 w-3" }) })
    ] }),
    canPost && imagePreview && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-t border-border bg-muted/40 px-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imagePreview, alt: "Preview", className: "h-12 w-12 rounded object-cover" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-xs text-muted-foreground", children: "Image attached" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        setImagePreview(null);
        if (fileInputRef.current) fileInputRef.current.value = "";
      }, className: "rounded-full p-1 hover:bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3 w-3" }) })
    ] }),
    canPost ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-t border-border bg-background px-2 py-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ref: fileInputRef, type: "file", accept: "image/*", className: "hidden", onChange: onPickFile }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => fileInputRef.current?.click(), className: "grid h-9 w-9 place-items-center rounded-full text-muted-foreground hover:bg-muted hover:text-foreground", "aria-label": "Attach image", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ImagePlus, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open: emojiOpen, onOpenChange: setEmojiOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "grid h-9 w-9 place-items-center rounded-full text-muted-foreground hover:bg-muted hover:text-foreground", "aria-label": "Emoji", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Smile, { className: "h-5 w-5" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverContent, { className: "w-auto p-2", align: "start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-8 gap-1", children: QUICK.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "grid h-8 w-8 place-items-center rounded text-lg hover:bg-muted", onClick: () => {
          setText((t) => t + e);
          setEmojiOpen(false);
        }, children: e }, e)) }) })
      ] }),
      ...
      }, placeholder: "Aa", className: "h-10 rounded-full bg-muted px-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", className: "h-10 w-10 shrink-0 rounded-full", onClick: sendMessage, disabled: sending || uploading || !text.trim() && !imagePreview, "aria-label": "Send", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "h-4 w-4" }) })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-background px-3 py-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] text-center text-xs text-muted-foreground", children: hasPurchase === false ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/buy", className: "font-display text-primary hover:underline", children: "Purchase a challenge" }),
      " to join and post."
    ] }) : "Loading…" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!lightbox, onOpenChange: (o) => !o && setLightbox(null), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-3xl bg-background p-2", children: lightbox && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: lightbox, alt: "Full size", className: "mx-auto max-h-[80vh] rounded" }) }) })
  ] });
}
export {
  GroupChatPage as component
};
